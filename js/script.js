...
function openMore(){
    if(title.innerHTML == "Denmark"){
        document.location='//en.wikipedia.org/wiki/Denmark'
    }
    else if(title.innerHTML == "Sweden"){
        document.location='//en.wikipedia.org/wiki/Sweden'
    }
    else if(title.innerHTML == "Ireland"){
        document.location='//en.wikipedia.org/wiki/Ireland'
    }
}
...
function openModalDenmark(){
     ...
     windowImg.style.background = "url(/train/img/Danmark.jpg) 0 0/100% auto no-repeat";
    }
...
function openModalSweden(){
    ...
    windowImg.style.background = "url(/train/img/sweden.jpg) 0 0/100% auto no-repeat";
 }
...
function openModalIrlandia(){
     ...
     windowImg.style.background = "url(/train/img/irlandija.jpg) 0 0/100% auto no-repeat";
    }
